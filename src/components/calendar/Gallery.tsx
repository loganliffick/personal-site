...
const Gallery = (props: {
  ...
  return (
    <li className="relative mx-2 overflow-hidden rounded-2xl">
      <button
        className="group relative aspect-video w-full overflow-hidden rounded-2xl bg-white after:absolute after:left-0 after:top-0 after:h-full after:w-full after:rounded-2xl after:border-[6px] after:border-white/50 after:transition-[border] sm:hover:after:border-[10px] sm:active:after:border-[16px]"
